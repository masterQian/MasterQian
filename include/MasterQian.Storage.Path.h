...
#undef MasterQianModuleVersion
	...
	/// 驱动器组操作对象
	/// </summary>
	struct Drivers : private std::vector<Driver> {
	...
	struct RecycleBin {
		...
		static void Clear(bool tip = false) noexcept {
